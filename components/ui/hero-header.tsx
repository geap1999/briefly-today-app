        ...
        >
          ...
          <View
            style={{
              ...
              backgroundColor: "rgba(255,255,255,0.05)",
              borderRadius: 9999,
              marginLeft: isTablet ? -80 : -64,
              marginBottom: isTablet ? -80 : -64,
            }}
          />

          <View className="items-center relative z-10">
            <Text
              className="font-semibold uppercase text-purple-200 mb-2 opacity-90"
              style={{ fontSize: getFontSize(11), letterSpacing: 3 }}
            >
